...
insert into ontology.resource_categories__reftable(unit_id, prefix, value_offset, value_length, pattern) values (195, 'https://identifiers.org/BTO:', 29, 7, '^https://identifiers\.org/BTO:[0-9]{7}$');
insert into ontology.resource_categories__reftable(unit_id, prefix, value_offset, value_length, pattern) values (196, 'https://identifiers.org/CL:', 28, 7, '^https://identifiers\.org/CL:[0-9]{7}$');
insert into ontology.resource_categories__reftable(unit_id, prefix, value_offset, value_length, pattern) values (197, 'https://identifiers.org/CLO:', 29, 7, '^https://identifiers\.org/CLO:[0-9]{7}$');
insert into ontology.resource_categories__reftable(unit_id, prefix, value_offset, value_length, pattern) values (198, 'https://identifiers.org/ctd.gene:', 34, 0, '^https://identifiers\.org/ctd\.gene:[1-9][0-9]*$');
insert into ontology.resource_categories__reftable(unit_id, prefix, value_offset, value_length, pattern) values (199, 'https://identifiers.org/DOID:', 30, 0, '^https://identifiers\.org/DOID:[1-9][0-9]*$');
insert into ontology.resource_categories__reftable(unit_id, prefix, value_offset, value_length, pattern) values (200, 'https://identifiers.org/DOID:', 30, 7, '^https://identifiers\.org/DOID:0[0-9]{6}$');
insert into ontology.resource_categories__reftable(unit_id, prefix, value_offset, value_length, pattern) values (201, 'https://identifiers.org/efo:', 29, 7, '^https://identifiers\.org/efo:[0-9]{7}$');
insert into ontology.resource_categories__reftable(unit_id, prefix, value_offset, value_length, pattern) values (202, 'https://identifiers.org/hgnc:', 30, 0, '^https://identifiers\.org/hgnc:[1-9][0-9]*$');
insert into ontology.resource_categories__reftable(unit_id, prefix, value_offset, value_length, pattern) values (203, 'https://identifiers.org/hpa:ENSG', 33, 11, '^https://identifiers\.org/hpa:ENSG[0-9]{11}$');
insert into ontology.resource_categories__reftable(unit_id, prefix, value_offset, value_length, pattern) values (204, 'https://identifiers.org/chembl:CHEMBL', 38, 0, '^https://identifiers\.org/chembl:CHEMBL[1-9][0-9]*$');
insert into ontology.resource_categories__reftable(unit_id, prefix, value_offset, value_length, pattern) values (205, 'https://identifiers.org/iuphar.receptor:', 41, 0, '^https://identifiers\.org/iuphar\.receptor:[1-9][0-9]*$');
insert into ontology.resource_categories__reftable(unit_id, prefix, value_offset, value_length, pattern) values (206, 'https://identifiers.org/kegg.disease:H', 39, 5, '^https://identifiers\.org/kegg\.disease:H[0-9]{5}$');
insert into ontology.resource_categories__reftable(unit_id, prefix, value_offset, value_length, pattern) values (207, 'https://identifiers.org/lincs.cell:LCL-', 40, 0, '^https://identifiers\.org/lincs\.cell:LCL-[1-9][0-9]*$');
insert into ontology.resource_categories__reftable(unit_id, prefix, value_offset, value_length, pattern) values (208, 'https://identifiers.org/medgen:C', 33, 7, '^https://identifiers\.org/medgen:C[0-9]{7}$');
insert into ontology.resource_categories__reftable(unit_id, prefix, value_offset, value_length, pattern) values (209, 'https://identifiers.org/medgen:CN', 34, 6, '^https://identifiers\.org/medgen:CN[0-9]{6}$');
insert into ontology.resource_categories__reftable(unit_id, prefix, value_offset, value_length, pattern) values (210, 'https://identifiers.org/MGI:', 29, 0, '^https://identifiers\.org/MGI:[1-9][0-9]*$');
insert into ontology.resource_categories__reftable(unit_id, prefix, value_offset, value_length, pattern) values (211, 'https://identifiers.org/mim:', 29, 0, '^https://identifiers\.org/mim:[1-9][0-9]*$');
insert into ontology.resource_categories__reftable(unit_id, prefix, value_offset, value_length, pattern) values (212, 'https://identifiers.org/NANDO:', 31, 0, '^https://identifiers\.org/NANDO:[1-9][0-9]*$');
insert into ontology.resource_categories__reftable(unit_id, prefix, value_offset, value_length, pattern) values (213, 'https://identifiers.org/ncit:C', 31, 0, '^https://identifiers\.org/ncit:C[1-9][0-9]*$');
insert into ontology.resource_categories__reftable(unit_id, prefix, value_offset, value_length, pattern) values (214, 'https://identifiers.org/orphanet:', 34, 0, '^https://identifiers\.org/orphanet:[1-9][0-9]*$');
insert into ontology.resource_categories__reftable(unit_id, prefix, value_offset, value_length, pattern) values (215, 'https://identifiers.org/pharmgkb.disease:PA', 44, 0, '^https://identifiers\.org/pharmgkb\.disease:PA[1-9][0-9]*$');
insert into ontology.resource_categories__reftable(unit_id, prefix, value_offset, value_length, pattern) values (216, 'https://identifiers.org/pharmgkb.gene:PA', 41, 0, '^https://identifiers\.org/pharmgkb\.gene:PA[1-9][0-9]*$');
insert into ontology.resource_categories__reftable(unit_id, prefix, value_offset, value_length, pattern) values (217, 'https://identifiers.org/rgd:', 29, 0, '^https://identifiers\.org/rgd:[1-9][0-9]*$');
insert into ontology.resource_categories__reftable(unit_id, prefix, value_offset, value_length, pattern) values (218, 'https://identifiers.org/sgd:S', 30, 9, '^https://identifiers\.org/sgd:S[0-9]{9}$');
insert into ontology.resource_categories__reftable(unit_id, prefix, value_offset, value_length, pattern) values (219, 'https://identifiers.org/umls:C', 31, 7, '^https://identifiers\.org/umls:C[0-9]{7}$');
insert into ontology.resource_categories__reftable(unit_id, prefix, value_offset, value_length, pattern) values (220, 'https://identifiers.org/xenbase:XB-GENE-', 41, 0, '^https://identifiers\.org/xenbase:XB-GENE-[1-9][0-9]*$');
insert into ontology.resource_categories__reftable(unit_id, prefix, value_offset, value_length, pattern) values (221, 'https://identifiers.org/xenbase:XB-GENEPAGE-', 45, 0, '^https://identifiers\.org/xenbase:XB-GENEPAGE-[1-9][0-9]*$');
