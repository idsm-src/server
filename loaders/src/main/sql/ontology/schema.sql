...
insert into ontology.resource_categories__reftable(unit_id, prefix, value_offset, value_length, pattern) values (256, 'http://www.wormbase.org/db/gene/gene?class=Gene;name=WBGene', 60,  8, '^http://www\.wormbase\.org/db/gene/gene\?class=Gene;name=WBGene[0-9]{8}$');
insert into ontology.resource_categories__reftable(unit_id, prefix, value_offset, value_length, pattern) values (257, 'https://wormbase.org/db/seq/protein?class=Protein;name=CBP', 59,  5, '^https://wormbase\.org/db/seq/protein\?class=Protein;name=CBP[0-9]{5}$');
insert into ontology.resource_categories__reftable(unit_id, prefix, value_offset, value_length, pattern) values (258, 'https://wormbase.org/db/seq/protein?class=Protein;name=CE', 58,  5, '^https://wormbase\.org/db/seq/protein\?class=Protein;name=CE[0-9]{5}$');
insert into ontology.resource_categories__reftable(unit_id, prefix, value_offset, value_length, pattern) values (259, 'https://wormbase.org/db/seq/protein?class=Protein;name=BM', 58,  5, '^https://wormbase\.org/db/seq/protein\?class=Protein;name=BM[0-9]{5}$');
insert into ontology.resource_categories__reftable(unit_id, prefix, value_offset, value_length, pattern) values (260, 'http://edamontology.org/data_', 30,  0, '^http://edamontology.org/data_[1-9][0-9]*$');
