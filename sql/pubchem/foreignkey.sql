...
-- biosystem
alter table pubchem.biosystem_bases add foreign key (source) references pubchem.source_bases(id) initially deferred;
alter table pubchem.biosystem_components add foreign key (biosystem) references pubchem.biosystem_bases(id) initially deferred;
alter table pubchem.biosystem_references add foreign key (biosystem) references pubchem.biosystem_bases(id) initially deferred;
alter table pubchem.biosystem_references add foreign key (reference) references pubchem.reference_bases(id) initially deferred;
alter table pubchem.biosystem_matches add foreign key (biosystem) references pubchem.biosystem_bases(id) initially deferred;
-- 175140 : alter table pubchem.biosystem_components add foreign key (component) references pubchem.biosystem_bases(id) initially deferred;
...
alter table pubchem.compound_biosystems add foreign key (compound) references pubchem.compound_bases(id) initially deferred;
alter table pubchem.compound_biosystems add foreign key (biosystem) references pubchem.biosystem_bases(id) initially deferred;
...
-- gene
alter table pubchem.gene_biosystems add foreign key (gene) references pubchem.gene_bases(id) initially deferred;
alter table pubchem.gene_biosystems add foreign key (biosystem) references pubchem.biosystem_bases(id) initially deferred;
...
-- 1 : alter table pubchem.protein_genes add foreign key (gene) references pubchem.gene_bases(id) initially deferred;
...
alter table pubchem.protein_processes add foreign key (protein) references pubchem.protein_bases(id) initially deferred;
alter table pubchem.protein_biosystems add foreign key (protein) references pubchem.protein_bases(id) initially deferred;
alter table pubchem.protein_biosystems add foreign key (biosystem) references pubchem.biosystem_bases(id) initially deferred;
alter table pubchem.protein_functions add foreign key (protein) references pubchem.protein_bases(id) initially deferred;
alter table pubchem.protein_locations add foreign key (protein) references pubchem.protein_bases(id) initially deferred;
