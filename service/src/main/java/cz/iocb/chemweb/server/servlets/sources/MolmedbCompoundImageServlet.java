...
public class MolmedbCompoundImageServlet extends HttpServlet
{
    ...
    public void init(ServletConfig config) throws ServletException
    {
        ...
        query = "select canonical_smiles from molmedb.substance_bases where identifier = ? and canonical_smiles is not null";
